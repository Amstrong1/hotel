<section id="bottom-navigation" class="py-4 block fixed inset-x-0 bottom-0 z-10 shadow"
    ...
    <div id="tabs" class="flex justify-between">
        ...
        <a href="{{ route('room.index') }}" class="w-full text-white justify-center inline-block text-center pt-2 pb-1">
            ...
            <span class="tab tab-kategori block text-xs">Chambre</span>
        </a>
        ...
        <a href="{{ route('reservation.index') }}"
            ...
            <span class="tab tab-kategori block text-xs">Reservations</span>
        </a>
        ...
        <a href="{{ route('message.index') }}"
            ...
            <span class="tab tab-kategori block text-xs">Messages</span>
        </a>
    </div>
</section>
